...
/*~ class.phpmailer.php
.---------------------------------------------------------------------------.
|  Software: PMailer - PHP email class                                    |
|   Version: 5.2.4                                                          |
...
/**
 * PMailer - PHP email creation and transport class
...
if (version_compare(PHP_VERSION, '5.0.0', '<') ) exit("Sorry, this version of PMailer will only run on PHP version 5 or greater!\n");
...
class PMailer {
  ...
  */
  ...
  /**
   * Path to PMailer plugins.  Useful if the SMTP class
 ...
 /**
  ...
  /**
   * Sets the PMailer Version number
   * @var string
   */
 ...
 */
  ...
  */
  ...
  public function CreateHeader() {
    ...
    if ($this->XMailer == '') {
        $result .= $this->HeaderLine('X-Mailer', 'PMailer '.$this->Version.' (http://code.google.com/a/apache-extras.org/p/phpmailer/)');
    } else {
