...
class Help extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('title, yes, no, content, alias, createtime', 'required'),
			array('yes, no', 'numerical', 'integerOnly'=>true),
			array('title, alias', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, title, yes, no, content, alias, createtime', 'safe', 'on'=>'search'),
		);
	}
