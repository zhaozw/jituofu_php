...
$lang = array_merge($lang,array(
    ...
    "ACCOUNT_NOEXIST_USERNAME"     => "该用户名没有在 %m1% 注册过",
	"ACCOUNT_USER_OR_EMAIL_INVALID"		=> "用户名或邮箱错误",
    "EMAIL_NO_REGISTER" => "%m1% 从未注册过",
	...
	"ACCOUNT_USERNAME_IN_USE"		=> "%m1% 已存在，请更换其它用户名",
	"ACCOUNT_DISPLAYNAME_IN_USE"		=> "%m1% 已存在，请更换其它小店名",
	"ACCOUNT_EMAIL_IN_USE"			=> "%m1% 已存在，请更换其它邮箱",
